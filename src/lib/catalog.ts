...
export function mapProduct(row: ProductRow): Product {
  ...
  return {
    ...
    imageUrl: productImageSrc(row.image_url),
    stock: row.stock ?? 0,
...
export const PRODUCT_SELECT =
  "id,name,slug,category_id,description,price,sale_price,stock,image_url,rating,review_count,is_active,is_featured,created_at,categories(name,slug)";
